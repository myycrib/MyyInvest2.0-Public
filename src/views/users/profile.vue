<template>
  <div id="msform">
    ...
    <section class="m-lg-5 p-lg-5" v-if="currentStep === 0 || currentStep === 1">
      <main-card class="p-4 form-border">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 d-none d-lg-block d-md-none">
              <div class="d-flex flex-lg-row flex-column flex-grow-1">
                ...
                <span class="d-flex flex-column">
                  <p class="float-right text-danger ft-12 mt-n4">Why Bvn?</p>
                  <p v-if="profile.bvn !== '' && typeof profile.bvn !== 'undefined'" class="p-1 text-white ft-12 bg-primary-default" style="border-radius:3px;">Confirmed</p>
                </span>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12 d-block d-lg-none d-md-block">
              <div class="d-flex flex-lg-row flex-column flex-grow-1">
                ...
                <p class="float-right text-danger col-md-3 ft-12 mt-n4">Why Bvn?</p>
              </div>
            </div>
